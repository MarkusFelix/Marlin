...
#define DISABLE_INACTIVE_X flase
#define DISABLE_INACTIVE_Y flase
#define DISABLE_INACTIVE_Z flase  // Set 'false' if the nozzle could fall onto your printed part!
=======
